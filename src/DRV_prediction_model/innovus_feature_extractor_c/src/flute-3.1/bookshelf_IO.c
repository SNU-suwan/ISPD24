...
/*-- functions --*/
    ...
    //static inline uint32_t get_hashfunc(const void *key, size_t length, uint32_t initval); //Convert inline to static inline to be compatible with cmake
    extern inline uint32_t get_hashfunc(const void *key, size_t length, uint32_t initval); //Convert inline to static inline to be compatible with cmake
    ...
    //static inline long getIndex(char temp[]);
    extern inline long getIndex(char temp[]);
...
----------------------------------------------------------------------- */
//inline uint32_t get_hashfunc(const void *key, size_t length, uint32_t initval)
//static inline uint32_t get_hashfunc(const void *key, size_t length, uint32_t initval)
extern inline uint32_t get_hashfunc(const void *key, size_t length, uint32_t initval)
{
