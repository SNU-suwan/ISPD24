...
/*************************************/
#define POWVFILE "./src/DRV_prediction_model/innovus_feature_extractor_c/src/flute-3.1/POWV9.dat"        // LUT for POWV (Wirelength Vector)
#define POSTFILE "./src/DRV_prediction_model/innovus_feature_extractor_c/src/flute-3.1/POST9.dat"        // LUT for POST (Steiner Tree)
